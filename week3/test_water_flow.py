...
def test_pressure_loss_from_pipe():
    ...
    assert pressure_loss_from_pipe(0.28687, 1000.00, 0.013, 1.65) == approx(-61.576, abs=0.001)
...
def test_kpa_to_psi():
    ...
    assert kpa_to_psi(6.894757293168361) == approx(1.0, abs=0.001)
    assert kpa_to_psi(100) == approx(14.504, abs=0.001)
    assert kpa_to_psi(150) == approx(21.756, abs=0.001)
